 ...
 */
public class TextureViewSampleActivity extends FragmentActivity {
    ...
    @InjectView(R.id.play_video_texture)
    TextureVideoView videoView;
    @InjectView(R.id.play_video_controller)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_texture_video_sample);
    ...
    private void initializeVideoView() {
        ...
        videoView.setOnPlayStateListener(playerController);
        videoView.setVideo(path, 0);
        videoView.start();
    }
